...
from baselines.ddpg_cnn.ddpg_cnn_learner import DDPG
from baselines.ddpg_cnn.models import Actor, Critic
...
def learn(network, env,
    ...
    critic = Critic(network=network, latent_size=latent_size, **network_kwargs)
    actor = Actor(nb_actions, network=network, latent_size=latent_size, **network_kwargs)
